...
\begin{document}
	...
	\cite{Wei_Liming_2010} proposes an algorithm which conducts vertically integral projection for each bone region within the X-ray image. The X-ray image is pre-processed before the vertically integral projection is conducted. The projections are further combined by with the projection on curves. The algorithm makes use of AO coding. According to 

...
\begin{document}
	...
	\end{figure}
	The performance for both the systems are compared to the performance of a single step neural network. The performance is evaluated by accuracy of detection, error rate, and execution speed.
